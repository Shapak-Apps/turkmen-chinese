// @ts-nocheck
// This file is disabled for now - will be re-enabled with AI features later
import { ConversationScenario } from "@/constants/CourseData";
import { Colors } from "@/constants/theme";
import { recordConversationTurn } from "@/lib/speakingListeningStats";
// supabase removed — will be re-enabled with AI features (Etap 6)
...
export default function ConversationMode({
  ...
  const callChatCompletion = async (params: {
    ...
    // AI chat disabled — will be re-enabled in Etap 6
    console.warn("Chat completion is disabled (no Supabase)");
    return null;
  };
