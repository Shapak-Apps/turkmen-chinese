...
> **Рабочий документ для разработки.** Сведён 2026-06-06 из старых
...
>
> **Что где:** описание проекта для внешнего читателя — в [README.md](README.md);
> задачи — в [Issues](https://github.com/Shapak-Apps/turkmen-chinese/issues);
> статус в жизненном цикле — на доске в `Shapak-Apps\HQ\board.html`.
> Здесь — только техника разработки и грабли. Статусы тут не дублируются, иначе разойдутся.

**Последнее обновление:** 2026-08-06 (репозиторий публичный, MIT; появился README (PR #8);
заведены 7 issue, из них 2 помечены `good first issue`; первый внешний контрибьютор —
@slegarraga поправил статус git в этом файле (PR #9). Проверки зелёные: `tsc` 0 · `lint` 0 ошибок ·
63 теста в 11 сюитах. Ранее: 2026-07-28 ТУРКМЕНИЗАЦИЯ КОНТЕНТА ЗАВЕРШЕНА — интерфейс + **все 30 из 30
...
Сначала прошли спринт **«довести качество до 7/10»** (файл `improve.md` удалён
2026-08-07: сделанное — история в git, живые пункты перенесены в issues
[#16](https://github.com/Shapak-Apps/turkmen-chinese/issues/16)–[#19](https://github.com/Shapak-Apps/turkmen-chinese/issues/19)),
затем **реализовали Stepik-редизайн целиком** (логика + UI, см. раздел ниже).
