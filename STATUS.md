...
После большого редизайна + добавления геймификации (см. WORKLOG 2026-05-14 и 2026-05-27) — приложение готово к релизу.

**Git:** инициализирован 2026-05-27, ветка `main`, первый коммит `dcab977`.
...
- ✅ Персонализация: имя пользователя в приветствии (вводится в онбординге)
...
- ✅ Awtor we wersiýa: брендинг Şapak Apps, контакт shapak.app@gmail.com

**Текущая задача:** тестирование release APK на реальном устройстве (продолжение завтра).
